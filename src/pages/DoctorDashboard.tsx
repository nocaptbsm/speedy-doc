    ...
    <div className="container mx-auto px-4 py-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <Card className="mb-6 shadow-soft">
          <CardContent className="flex items-center justify-between p-4">
            <div className="flex items-center gap-3">
              <MessageCircle className={`h-5 w-5 ${isWhatsAppEnabled ? 'text-green-500' : 'text-muted-foreground'}`} />
              <div>
                <p className="font-semibold text-foreground">WhatsApp Notifications</p>
                <p className="text-xs text-muted-foreground">Open WhatsApp when calling a patient</p>
              </div>
            </div>
            <Button
              ...
              className={isWhatsAppEnabled ? "border-green-500 text-green-600 hover:bg-green-50" : ""}
            >
